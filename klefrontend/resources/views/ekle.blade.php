        ...
        <div class="card-body">
            <form id="addUserForm" method="POST" action="{{ route('store.product')}}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="name" name="title" placeholder="Ürün adı" required>
                </div>
    
                <div class="mb-3">
                    <label class="form-label">Ürün Açıklaması</label>
                    <input type="text" class="form-control" id="description" name="text" placeholder="Açıklama" required>
                </div>
